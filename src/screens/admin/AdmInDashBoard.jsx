                ...
                <div className="h-full px-4 sm:col-span-8  ">
                  ...
                  <div className="grid grid-cols-1 w-full my-1">
                    ...
                    <div className="flex justify-between items-center py-6 px-2 bg-white">
                      <h4 className="font-thin">RECENT USERS</h4>
                      <div className=" mx-6 font-bold text-sm p-2 bg-gray-100 hover:bg-gray-200  rounded-md cursor-pointer"></div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 bg-white sm:pb-6 max-sm:pb-12">
                      ...
                      <NavLink to={"/admin/users"}>
                        <div className="col-span-2 h-16 p-2  w-16">
                          ...
                          <label className="font-thin text-sm cursor-pointer">
                            View all
                          </label>
                        </div>
                      </NavLink>
                      ...
                      {dash.data.top_product.map((item) => (
                        <>
                          <div className="flex my-4 ">
                            ...
                            <div className="grid">
                              <span className="mx-3 text-black font-bold">
                                {item.name}
                              </span>
                              <span className="mx-3 text-black font-medium">
                                ₹{item.price}
                              </span>
                              <span className="mx-3 text-black">
                                by {item.artist?.name?.toUpperCase()}
                              </span>
                            </div>
                          </div>
                        </>
