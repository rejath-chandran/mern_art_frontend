...
const AdminEditCategory = ({ data, edit }) => {
  ...
  return (
    <>
      <button className="btn mx-1" onClick={() => ShowModal(true)}>
        EDIT
      </button>
      {modal && (
        <>
          <dialog id="my_modal_2" className="modal modal-open">
            <div className="modal-box">
              <div className="w-full h-full">
                ...
                <input value={data._id} {...register("id")} hidden={true} />
                ...
                />
                {errors.name && (
                  <span className="text-error"> name is needed</span>
                )}
                ...
                />
                {errors.sample_img && (
                  <span className="text-error"> image is needed</span>
                )}
                ...
                <div>
                  {errors.desc && (
                    <span className="text-error"> desc is needed</span>
                  )}
                </div>
                <button
